...
func newFollow(db *gorm.DB, opts ...gen.DOOption) follow {
	...
	_follow.Follow = field.NewInt64(tableName, "follow")
	_follow.ToFollow = field.NewInt64(tableName, "to_follow")
...
func (f *follow) updateTableName(table string) *follow {
	...
	f.Follow = field.NewInt64(table, "follow")
	f.ToFollow = field.NewInt64(table, "to_follow")
...
func (f *follow) fillFieldMap() {
	...
	f.fieldMap["follow"] = f.Follow
	f.fieldMap["to_follow"] = f.ToFollow
