...
func newMessage(db *gorm.DB, opts ...gen.DOOption) message {
	...
	_message.Send = field.NewInt64(tableName, "send")
	_message.Receive = field.NewInt64(tableName, "receive")
...
func (m *message) updateTableName(table string) *message {
	...
	m.Send = field.NewInt64(table, "send")
	m.Receive = field.NewInt64(table, "receive")
...
func (m *message) fillFieldMap() {
	...
	m.fieldMap["id"] = m.ID
	m.fieldMap["send"] = m.Send
	m.fieldMap["receive"] = m.Receive
