...
func (c *commentClient) Comment(ctx context.Context, in *CommentRequest, opts ...grpc.CallOption) (*CommentResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/comment/comment", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *commentClient) CommentList(ctx context.Context, in *CommentListRequest, opts ...grpc.CallOption) (*CommentListResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/comment/comment_list", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Comment_CommentList_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/comment/comment_list",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
