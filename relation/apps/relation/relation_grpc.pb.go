...
func (c *relationClient) Follow(ctx context.Context, in *FollowRequest, opts ...grpc.CallOption) (*FollowResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/dousheng.relation.relation/follow", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *relationClient) FollowJudge(ctx context.Context, in *FollowJudgeRequest, opts ...grpc.CallOption) (*FollowJudgeResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/dousheng.relation.relation/follow_judge", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *relationClient) FollowList(ctx context.Context, in *FollowListRequest, opts ...grpc.CallOption) (*FollowListResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/dousheng.relation.relation/follow_list", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *relationClient) FollowerList(ctx context.Context, in *FollowerListRequest, opts ...grpc.CallOption) (*FollowerListResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/dousheng.relation.relation/follower_list", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *relationClient) FriendList(ctx context.Context, in *FriendListRequest, opts ...grpc.CallOption) (*FriendListResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/dousheng.relation.relation/friend_list", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Relation_Follow_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/dousheng.relation.relation/follow",
	}
...
func _Relation_FollowJudge_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/dousheng.relation.relation/follow_judge",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Relation_FollowList_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/dousheng.relation.relation/follow_list",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Relation_FollowerList_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/dousheng.relation.relation/follower_list",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Relation_FriendList_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/dousheng.relation.relation/friend_list",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var Relation_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "dousheng.relation.relation",
