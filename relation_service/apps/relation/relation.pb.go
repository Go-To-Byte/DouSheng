...
func (x *UserFollowPo) GetFollowFlag() bool {
	if x != nil {
		return x.FollowFlag
	}
	return false
...
func (x *UserFollowerPo) GetFollowerFlag() bool {
	if x != nil {
...
func (x *FollowActionRequest) GetActionType() string {
	if x != nil {
		return x.ActionType
	}
	return ""
...
var file_apps_relation_pb_relation_proto_rawDesc = []byte{
	...
	0x01, 0x28, 0x08, 0x52, 0x0a, 0x66, 0x6f, 0x6c, 0x6c, 0x6f, 0x77, 0x46, 0x6c, 0x61, 0x67, 0x22,
	...
	0x28, 0x08, 0x52, 0x0c, 0x66, 0x6f, 0x6c, 0x6c, 0x6f, 0x77, 0x65, 0x72, 0x46, 0x6c, 0x61, 0x67,
	...
	0x28, 0x09, 0x52, 0x0a, 0x61, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x54, 0x79, 0x70, 0x65, 0x22, 0x96,
