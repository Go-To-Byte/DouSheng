...
type FeedVideosRequest struct {
	...
	// 可选参数，登录用户ID设置
	// @gotags: json:"login_user_id"
	LoginUserId *int64 `protobuf:"varint,3,opt,name=login_user_id,json=loginUserId,proto3,oneof" json:"login_user_id"`
}
...
func (x *FeedVideosRequest) GetLoginUserId() int64 {
...
type PublishVideoRequest struct {
	...
	// 作者ID
	// @gotags: json:"author_id" validate:"required"
	AuthorId int64 `protobuf:"varint,1,opt,name=author_id,json=authorId,proto3" json:"author_id" validate:"required"`
	// 视频标题
	...
	// 视频播放地址 [经过文件上传后设置]
	// @gotags: json:"play_url" validate:"required"
	PlayUrl string `protobuf:"bytes,3,opt,name=play_url,json=playUrl,proto3" json:"play_url" validate:"required"`
	// 视频封面地址 [经过文件上传后设置]
	// @gotags: json:"cover_url"validate:"required"
	CoverUrl string `protobuf:"bytes,4,opt,name=cover_url,json=coverUrl,proto3" json:"cover_url" validate:"required"`
}
...
var file_apps_video_pb_video_proto_rawDesc = []byte{
	...
	0x73, 0x68, 0x65, 0x6e, 0x67, 0x2e, 0x76, 0x69, 0x64, 0x65, 0x6f, 0x22, 0x82, 0x01, 0x0a, 0x05,
	...
	0x22, 0xa3, 0x01, 0x0a, 0x07, 0x56, 0x69, 0x64, 0x65, 0x6f, 0x50, 0x6f, 0x12, 0x0e, 0x0a, 0x02,
	...
	0x72, 0x55, 0x72, 0x6c, 0x12, 0x14, 0x0a, 0x05, 0x74, 0x69, 0x74, 0x6c, 0x65, 0x18, 0x04, 0x20,
	...
	0x61, 0x74, 0x65, 0x64, 0x41, 0x74, 0x22, 0x63, 0x0a, 0x0b, 0x50, 0x61, 0x67, 0x65, 0x52, 0x65,
	...
	,
	...
	,
	...
	,
	...
	0x73, 0x74, 0x1a, 0x24, 0x2e, 0x64, 0x6f, 0x75, 0x73, 0x68, 0x65, 0x6e, 0x67, 0x2e, 0x76, 0x69,
	0x64, 0x65, 0x6f, 0x2e, 0x50, 0x75, 0x62, 0x6c, 0x69, 0x73, 0x68, 0x56, 0x69, 0x64, 0x65, 0x6f,
	0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x56, 0x0a, 0x0b, 0x50, 0x75, 0x62, 0x6c,
	0x69, 0x73, 0x68, 0x4c, 0x69, 0x73, 0x74, 0x12, 0x22, 0x2e, 0x64, 0x6f, 0x75, 0x73, 0x68, 0x65,
	0x6e, 0x67, 0x2e, 0x76, 0x69, 0x64, 0x65, 0x6f, 0x2e, 0x50, 0x75, 0x62, 0x6c, 0x69, 0x73, 0x68,
	0x4c, 0x69, 0x73, 0x74, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x23, 0x2e, 0x64, 0x6f,
	...
	,
...
var file_apps_video_pb_video_proto_msgTypes = make([]protoimpl.MessageInfo, 11)
var file_apps_video_pb_video_proto_goTypes = []interface{}{
	...
	(*GetVideoRequest)(nil),      // 9: dousheng.video.GetVideoRequest
	nil,                          // 10: dousheng.video.PublishVideoResponse.MateEntry
}
var file_apps_video_pb_video_proto_depIdxs = []int32{
	...
	10, // 2: dousheng.video.PublishVideoResponse.mate:type_name -> dousheng.video.PublishVideoResponse.MateEntry
	...
	9,  // 7: dousheng.video.Service.GetVideo:input_type -> dousheng.video.GetVideoRequest
	...
	0,  // 11: dousheng.video.Service.GetVideo:output_type -> dousheng.video.Video
