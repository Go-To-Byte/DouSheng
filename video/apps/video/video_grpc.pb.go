...
func (c *videoClient) Publish(ctx context.Context, in *PublishRequest, opts ...grpc.CallOption) (*PublishResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/dousheng.video.video/publish", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *videoClient) PublishList(ctx context.Context, in *PublishListRequest, opts ...grpc.CallOption) (*PublishListResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/dousheng.video.video/publish_list", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *videoClient) Info(ctx context.Context, in *VideoInfoRequest, opts ...grpc.CallOption) (*VideoInfoResponse, error) {
	out := new(VideoInfoResponse)
	err := c.cc.Invoke(ctx, "/dousheng.video.video/info", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *videoClient) Feed(ctx context.Context, in *FeedRequest, opts ...grpc.CallOption) (*FeedResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/dousheng.video.video/feed", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Video_Publish_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/dousheng.video.video/publish",
	}
...
func _Video_PublishList_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/dousheng.video.video/publish_list",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Video_Info_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(VideoInfoRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(VideoServer).Info(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/dousheng.video.video/info",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(VideoServer).Info(ctx, req.(*VideoInfoRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _Video_Feed_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/dousheng.video.video/feed",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var Video_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "dousheng.video.video",
